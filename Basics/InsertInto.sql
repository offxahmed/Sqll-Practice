-- t is possible to write the INSERT INTO statement in two ways:
...
INSERT INTO customers (CustomerName , CustomerID, City, Country )
VALUES ('Ahmad','Bsdsf24m013','Lahore','Pakistan')
...
-- Can Also add the multiple rows into the Table 
